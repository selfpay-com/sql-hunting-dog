...
namespace DatabaseObjectSearcher
{
	public class ObjectExplorerManager
	{
		...
		public ObjectExplorerManager(IServiceProvider package)
		{
		...
		private const String UserPref_ServerDatabase = "[database]:"; //TODO: refactor => same const in Face.xaml.cs
					...
					if (n != null)
					{
						...
						else if (n.ViewIdentity == "Server/Database")
						{
							if (OnDatabaseChanged != null)
								OnDatabaseChanged(n.Connection.ServerName, n.Name);
						}
					}
				}
			}
